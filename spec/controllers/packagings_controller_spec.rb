...
RSpec.describe PackagingsController, :type => :controller do
  ...
  let(:packaging) { create(:packaging, commodity_id: commodity.id, name: "Milk Packaging", uom: "packets") }
  ...
  context "As an authenticated user" do
    ...
    describe "GET #show" do
      it "returns 200 http status code" do
        get :show, params: { app_id: app.id, commodity_id: commodity.id, id: packaging.id }
